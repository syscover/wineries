...
class Winery extends Model
{
    ...
    public function addToGetIndexRecords($request, $parameters)
    {
        ...
        if(isset($parameters['lang'])) $query->where('lang_191', $parameters['lang']);
    ...
    public static function getRecords($parameters)
    {
        ...
        if(isset($parameters['lang_191'])) $query->where('lang_191', $parameters['lang_191']);
        if(isset($parameters['territorial_area_1_190'])) $query->where('territorial_area_1_190', $parameters['territorial_area_1_190']);
